...
public class VehicleControllerTest {
    ...
    private VehicleDto createVehicle(String carPlateNumber, String chassisNumber) {
    ...
    private String getObjectAsString(VehicleDto vehicleProfile) throws JsonProcessingException {
        val objectMapper = new ObjectMapper();
        return objectMapper.writeValueAsString(vehicleProfile);
    }


    private VehicleDto mapResultToObject(String jsonResult) throws JsonProcessingException {
        val objectMapper = new ObjectMapper();
        return objectMapper.readValue(jsonResult,VehicleDto.class);
    }
}
